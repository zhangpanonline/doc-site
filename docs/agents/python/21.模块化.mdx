...
sidebar_position: 21
title: '21. 模块化'
description: "Python 模块化：包、模块与成员的关系，import 机制与 __init__.py。"
...
<a href="/teach/lessons/0021-模块化.html"><strong>👉 点击进入《模块化互动教学课程》</strong></a>

- ⏱️ 预计 10–15 分钟：知识速览 + 9 道分级测验（初/中/高级各 3 道）+ 面试实战 + 4 道源课程作业（费曼复述与 __slots__ 研究）改编的最终考核
- 📋 配套<a href="/teach/reference/模块化速查表.html">《模块化速查表》</a>，可打印
