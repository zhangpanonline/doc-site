...
sidebar_position: 15
title: '15. 描述符'
description: "Python 描述符协议：__get__、__set__、__delete__ 的实现与 property 的底层原理。"
...
<a href="/teach/lessons/0015-描述符.html"><strong>👉 点击进入《描述符互动教学课程》</strong></a>

- ⏱️ 预计 10–15 分钟：知识速览 + 9 道分级测验（初/中/高级各 3 道）+ 面试实战 + 4 道源课程作业（只读属性/范围验证/访问计数器）改编的最终考核
- 📋 配套<a href="/teach/reference/描述符速查表.html">《描述符速查表》</a>，可打印
