...
sidebar_position: 31
title: '31. monorepo'
description: "Monorepo 单仓库策略：多项目多包的组织方式与工具链。"
...
<a href="/teach/lessons/0031-monorepo.html"><strong>👉 点击进入《Monorepo 互动教学课程》</strong></a>

- ⏱️ 预计 10–15 分钟：知识速览 + 9 道分级测验（初/中/高级各 3 道）+ 面试实战 + 4 道源课程作业（手工复现 workspace 工程）改编的最终考核
- 📋 配套<a href="/teach/reference/monorepo速查表.html">《Monorepo 速查表》</a>，可打印
