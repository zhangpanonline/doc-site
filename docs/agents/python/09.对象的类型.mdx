...
sidebar_position: 9
title: '09. 对象的类型'
description: "Python 对象的类型：type() 与 isinstance 判断类型，动态定义类的方法。"
...
<a href="/teach/lessons/0009-对象的类型.html"><strong>👉 点击进入《对象的类型互动教学课程》</strong></a>

- ⏱️ 预计 10–15 分钟：知识速览 + 9 道分级测验（初/中/高级各 3 道）+ 面试实战 + 4 道源课程作业（demo1.py 逐行预测）改编的最终考核
- 📋 配套<a href="/teach/reference/对象的类型速查表.html">《对象的类型速查表》</a>，可打印
