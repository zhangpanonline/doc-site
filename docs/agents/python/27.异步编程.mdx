...
sidebar_position: 27
title: '27. 异步编程'
description: "Python 异步编程：用 asyncio 高效开发，异步生成器、异步上下文管理器与常用 API。"
...
<a href="/teach/lessons/0027-异步编程.html"><strong>👉 点击进入《异步编程互动教学课程》</strong></a>

- ⏱️ 预计 10–15 分钟：知识速览 + 9 道分级测验（初/中/高级各 3 道）+ 面试实战 + 4 道源课程作业（读懂多智能体异步代码）改编的最终考核
