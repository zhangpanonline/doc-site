...
sidebar_position: 8
title: '08. 类和对象'
description: "Python 类和对象：面向对象编程入门，属性、方法、封装与实例化。"
...
<a href="/teach/lessons/0008-类和对象.html"><strong>👉 点击进入《类和对象互动教学课程》</strong></a>

- ⏱️ 预计 10–15 分钟：知识速览 + 9 道分级测验（初/中/高级各 3 道）+ 面试实战 + 4 道源课程作业改编的最终考核（含腾讯面试题）
- 📋 配套<a href="/teach/reference/类和对象速查表.html">《类和对象速查表》</a>，可打印
