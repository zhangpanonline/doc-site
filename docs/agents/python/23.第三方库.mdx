...
sidebar_position: 23
title: '23. 第三方库'
description: "Python 第三方库：pip 包管理、依赖安装与常用库生态介绍。"
...
<a href="/teach/lessons/0023-第三方库.html"><strong>👉 点击进入《第三方库互动教学课程》</strong></a>

- ⏱️ 预计 10–15 分钟：知识速览 + 9 道分级测验（初/中/高级各 3 道）+ 面试实战 + 4 道源课程作业（命令行 AI 聊天工具）改编的最终考核
