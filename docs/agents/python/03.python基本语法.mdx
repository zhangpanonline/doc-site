...
sidebar_position: 3
title: '03. python基本语法'
description: "Python 基本语法：解释型与强类型特性、变量、注释、基本数据类型与运算符入门。"
...
<a href="/teach/lessons/0003-python基本语法.html"><strong>👉 点击进入《python基本语法互动教学课程》</strong></a>

- ⏱️ 预计 10–15 分钟：知识速览 + 9 道分级测验（初/中/高级各 3 道）+ 面试实战 + 4 道源课程作业改编的最终考核
- 📋 配套<a href="/teach/reference/python基本语法速查表.html">《python基本语法速查表》</a>，可打印
