---
sidebar_position: 26
title: '26. 协程 Coroutine'
description: "Python 协程 Coroutine：async/await 语法、协程的调度与回调之痛。"
slug: 协程-Coroutine
...
<a href="/teach/lessons/0026-协程-Coroutine.html"><strong>👉 点击进入《协程 Coroutine 互动教学课程》</strong></a>

- ⏱️ 预计 15–20 分钟，9 道分级测验（初/中/高级各 3 道）+ 面试实战
- 📋 配套<a href="/teach/reference/协程-Coroutine速查表.html">《协程-Coroutine速查表》</a>，术语与语法一页装下，可打印
