...
sidebar_position: 14
title: '14. 魔术方法'
description: "Python 魔术方法：__init__、__str__、__add__ 等双下划线方法的自动触发机制。"
...
<a href="/teach/lessons/0014-魔术方法.html"><strong>👉 点击进入《魔术方法互动教学课程》</strong></a>

- ⏱️ 预计 10–15 分钟：知识速览 + 9 道分级测验（初/中/高级各 3 道）+ 面试实战 + 4 道源课程作业（Fraction 分数类）改编的最终考核
- 📋 配套<a href="/teach/reference/魔术方法速查表.html">《魔术方法速查表》</a>，可打印
